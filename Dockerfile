...
ADD https://github.com/benbjohnson/litestream/releases/download/v0.3.5-alpha.9/litestream-v0.3.5-alpha.9-linux-amd64-static.tar.gz /tmp/litestream.tar.gz
